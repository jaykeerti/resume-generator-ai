    ...
    <div className="w-full max-w-md space-y-6">
      <div className="space-y-2 text-center">
        ...
        <p className="text-zinc-600 dark:text-zinc-400">
          Start creating tailored resumes with AI
        </p>
      </div>
      ...
      <form action={handleSubmit} className="space-y-4">
        <div className="space-y-2">
          ...
          <input
            ...
            type="email"
            required
            className="w-full rounded-lg border border-zinc-300 px-4 py-2 focus:border-zinc-900 focus:outline-none focus:ring-1 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-900 dark:focus:border-zinc-50 dark:focus:ring-zinc-50"
